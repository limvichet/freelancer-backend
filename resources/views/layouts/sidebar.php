<div id="sidebar-menu" class="main_menu_side hidden-print main_menu ml-2">
    ...
    <div class="menu_section">
        <h3>Live On</h3>
        <ul class="nav side-menu">
            <li><a><i class="fa fa-bug"></i> Additional Pages <span class="fa fa-chevron-right"></span></a>
                <ul class="nav child_menu">
            ...
            <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-right"></span></a>
                <ul class="nav child_menu">
            ...
            <li><a><i class="fa fa-sitemap"></i> Multilevel Menu <span class="fa fa-chevron-right"></span></a>
                <ul class="nav child_menu">
                    <li><a href="#level1_1">Level One</a>
                    <li><a>Level One<span class="fa fa-chevron-right"></span></a>
                        <ul class="nav child_menu">
