...
class ProvinceController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            $query   = Province::orderBy('pro_code', 'ASC');
    ...
    public function store(Request $request)
    {
        try {
            $request->validate([
                'pro_code'   => 'required|string|unique:sys_location_provinces,pro_code',
            ...
            return response()->json([
                ...
                'data' =>  Province::findOrFail($request->pro_code),
            ], 201);
    ...
    {
        try {
            $data = Province::where('pro_code', $id)->firstOrFail();
            ...
            $request->validate([
                'pro_code'   => [
                    ...
                    'string',
                    'max:2',
                    Rule::unique('sys_location_provinces', 'pro_code')->ignore($data->pro_code, 'pro_code'),
                ],
                'name_en'    => 'required|string',
